...
public interface KPSPublicSoap {
    ...
    @RequestWrapper(localName = "TCKimlikNoDogrula", targetNamespace = "http://tckimlik.nvi.gov.tr/WS", className = "tr.gov.nvi.tckimlik.TCKimlikNoDogrula")
    @ResponseWrapper(localName = "TCKimlikNoDogrulaResponse", targetNamespace = "http://tckimlik.nvi.gov.tr/WS", className = "tr.gov.nvi.tckimlik.TCKimlikNoDogrulaResponse")
